...
public class Texture
{
                                             ...
                                             AssetManager assets)
    {
        ...
        try
        {
            ...
            BitmapFactory.decodeStream(bufferedStream,new Rect(),options);
            if (options.outWidth>360){
//                options.outHeight = options.outHeight * 720 / options.outWidth;
//                options.outWidth = 720;
            ...
            bufferedStream = new BufferedInputStream(
                    inputStream);
            Bitmap bitMap = BitmapFactory.decodeStream(bufferedStream,new Rect(),options);
